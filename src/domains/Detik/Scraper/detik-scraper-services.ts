...
import DetikRepository from './detik-scraper-repository';
...
class DetikScraperServices {
    private repository = new DetikRepository();
...
export default DetikScraperServices;